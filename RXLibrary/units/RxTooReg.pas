...
uses
  ...
  {$IFNDEF VER80}RxNotify, RxGrdCpt, RxGradEdit, {$ENDIF}RxHintProp, ToolsAPI, RxViewer, RxGIFCtrl,
...
{ Components }
  RegisterComponents(srRXTools, [TPicClip, TFormStorage,
    TFormPlacement, TRxWindowHook, TAppEvents, TSpeedbar, TRxCalculator, TRxGIFAnimator,
